    ...
    return(
        ...
        <div className="ann">
            ...
            <p className='ann-text'>
                Here is the breakdown of time we anticipate <br/>
            ...
            <div className="ann-left">
                <div className="ann-left-1">
                    ...
                    <p className="ann-left-text">
                        The getlinked tech Hackathon1.0 is formally announced <br/>
                ...
                <div className="ann-left-1">
                    ...
                    <p className="ann-left-text">
                        Accepted team can now proceed to build their<br/>
            ...
            <div className="ann-left-1">
                ...
                <div className="ann-left-1">
                    ...
                    <p className="ann-left-text">
                       Interested team can now show their interest in the<br/>
                ...
                <div className="ann-left-1">
                    <h1 className="ann-left-header">
                        Announcement of the Accepted team <br/>and ideas

                    </h1>
                    <p className="ann-left-text">
                        All teams ideas that has been accepted into getlinked tech<br/>
                ...
                <div className="ann-left-1">
                    ...
                    <p className="ann-left-text">
                        Teams get opportunity to pitch their projects to judges.<br/>
                        The winner of the Hackathon will also be announced on<br/> this day.
                    </p>
                </div>
                </div>
                </div>
